...
enh <- read.table("data/ConsensusSet/KitchenSink2/KitchenSink2.Consensus.Catalogue.Enhancers.bed", header=F, sep="\t", stringsAsFactors = F,check.names = F)
...
save(kcca.cl, file=paste0("results/KitchenSink2/Cluster/KCCA.Flexclust/kccadata/KCCA.KitchenSink2.Enhancer.", numk,".Rdata"))
rownames.obj <- rownames(mat)
save(rownames.obj, file=paste0("results/KitchenSink2/Cluster/KCCA.Flexclust/kccadata/KCCA.KitchenSink2.Enhancer.rownames.", numk,".Rdata"))

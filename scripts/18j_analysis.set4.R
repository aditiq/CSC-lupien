...
gbmep <- fread("results/PCSC1/cicero/run2.readcount/GBM.E-P.txt", header=F, sep="\t", stringsAsFactors=F, data.table=F)
lscep <- fread("results/PCSC1/cicero/run2.readcount/LSCp.E-P.txt", header=F, sep="\t", stringsAsFactors=F, data.table=F)
pfaep <- fread("results/PCSC1/cicero/run2.readcount/PFA.E-P.txt", header=F, sep="\t", stringsAsFactors=F, data.table=F)

files <- dir("results/PCSC1/cicero/run2.readcount/", full.names=T, pattern=".coaccessgt")
files <- files[grep(".txt", files)]
files <- files[grep("E-P.genes.txt", files)]
...
commondf$label <- ifelse(commondf$coaccess < 0.8, "", commondf$epfreq)

pdf("results/PCSC1/cicero/run2.readcount/summary.plots/No.of.Common.EP.pairs.pdf")
...
pdf("results/PCSC1/cicero/run2.readcount/summary.plots/No.of.notshared.EP.pairs.pdf")
...
pdf("results/PCSC1/cicero/run2.readcount/summary.plots/Prop.of.GBM.common.notshared.EP.pairs.pdf")
ggplot() +
...
pdf("results/PCSC1/cicero/run2.readcount/summary.plots/Prop.of.PFA.common.notshared.EP.pairs.pdf")
ggplot() +
...
pdf("results/PCSC1/cicero/run2.readcount/summary.plots/Prop.of.LSCp.common.notshared.EP.pairs.pdf")
ggplot() +
...
pdf("results/PCSC1/cicero/run2.readcount/summary.plots/Prop.of.common.notshared.EP.pairs.pdf")
ggplot() +

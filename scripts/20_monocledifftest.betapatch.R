...
source("scripts/monocle_patch.R")
...
group=factor(groupinfo[,2]),stringsAsFactors=F)
names(pda) = c("Name", "ReadDepth","Group")
...
differtest = differentialGeneTest(submat_cds, fullModelFormulaStr = "~Group + ReadDepth",  reducedModelFormulaStr = "~ReadDepth", cores=1)

...
save(rownames.obj, file=paste0("results/PCSC1/Cluster/KCCA.Flexclust/kccadata/KCCA.Promoter.rownames.", numk,".Rdata"))
kcca.cl <- kcca_Wouter(x=mat, k=numk, family=fam, control=ctrl,stop_percentage=0.0001);
save(kcca.cl, file=paste0("results/PCSC1/Cluster/KCCA.Flexclust/kccadata/KCCA.Promoter.", numk,".Rdata"))
...
save(kcca.cl, file=paste0("results/PCSC1/Cluster/KCCA.Flexclust/kccadata/KCCA.PromoterwdtSingletons.", numk,".Rdata"))
rownames.obj2 <- rownames(mat3)
save(rownames.obj2 , file=paste0("results/PCSC1/Cluster/KCCA.Flexclust/kccadata/KCCA.PromoterwdtSingletons.rownames.", numk,".Rdata"))

...
binarymat <- read.table("data/ConsensusSet/PCSC1/Combined.Blood.Consensus.Catalogue.Binarymat.txt", header=T, sep="\t", stringsAsFactors = F,check.names = F)
...
save(kcca.cl, file=paste0("results/PCSC1/Cluster/KCCA.Flexclust/kccadata/KCCA.Blood.", numk,".Rdata"))
rownames.obj <- rownames(mat)
save(rownames.obj, file=paste0("results/PCSC1/Cluster/KCCA.Flexclust/kccadata/KCCA.Blood.rownames.", numk,".Rdata"))

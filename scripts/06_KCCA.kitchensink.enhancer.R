...
enh <- read.table("data/ConsensusSet/KitchenSink1/KitchenSink1.Consensus.Catalogue.Enhancers.bed", header=F, sep="\t", stringsAsFactors = F,check.names = F)
...
save(kcca.cl, file=paste0("results/KitchenSink1/Cluster/KCCA.Flexclust/kccadata/KCCA.KitchenSink1.Enhancer.", numk,".Rdata"))
rownames.obj <- rownames(mat)
save(rownames.obj, file=paste0("results/KitchenSink1/Cluster/KCCA.Flexclust/kccadata/KCCA.KitchenSink1.Enhancer.rownames.", numk,".Rdata"))
